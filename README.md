...
8. **Scatter Plot of the Relationship Between Uploads and Earnings**
<img width="879" alt="8" src="https://github.com/user-attachments/assets/4bbd877e-39ec-4156-85a9-cd7ac20fa949">
...
11. **Multivariate Analysis of Subscribers and Earnings by Continent**
![11](https://github.com/user-attachments/assets/304f0ed6-d7bf-4cfa-80cc-f372fde2c3e2)
...
## Results
1. **Category Activity:** The analysis revealed that the Entertainment category has the highest activity count on YouTube, followed closely by Music. In contrast, the Travel & Events category exhibited the lowest level of activity.
2. **Country Insights:** Among countries, the United States leads with the highest number of YouTubers, showcasing its dominance in content creation on the platform. India ranks second in the number of YouTubers, indicating a significant presence in the creator economy.
3. **Continental Trends:** In terms of continents, North America stands out with the highest number of YouTubers, while Africa ranks the lowest in creator presence.
